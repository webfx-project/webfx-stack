package dev.webfx.stack.auth.authz.client.operation;
...
import dev.webfx.stack.auth.authz.client.spi.impl.inmemory.parser.SimpleInMemoryAuthorizationRuleParserBase;
