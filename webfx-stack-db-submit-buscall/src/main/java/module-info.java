...
module webfx.stack.db.submit.buscall {
    ...
    provides dev.webfx.stack.com.serial.spi.SerialCodec with dev.webfx.stack.db.submit.buscall.serial.SubmitArgumentSerialCodec, dev.webfx.stack.db.submit.buscall.serial.SubmitResultSerialCodec, dev.webfx.stack.db.submit.buscall.serial.GeneratedKeyReferenceSerialCodec;
