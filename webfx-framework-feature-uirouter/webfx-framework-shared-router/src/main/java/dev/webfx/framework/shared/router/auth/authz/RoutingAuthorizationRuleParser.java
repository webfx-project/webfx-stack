package dev.webfx.framework.shared.router.auth.authz;
...
import dev.webfx.framework.shared.services.authz.spi.impl.inmemory.parser.SimpleInMemoryAuthorizationRuleParserBase;
