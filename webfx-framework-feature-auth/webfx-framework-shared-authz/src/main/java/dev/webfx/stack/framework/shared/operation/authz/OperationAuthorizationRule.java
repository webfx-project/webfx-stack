package dev.webfx.stack.framework.shared.operation.authz;
...
import dev.webfx.stack.framework.shared.services.authz.spi.impl.inmemory.SimpleInMemoryAuthorizationRuleBase;
