package dev.webfx.stack.platform.websocketbus.web;

import dev.webfx.stack.platform.shared.services.bus.BusOptions;
import dev.webfx.stack.platform.websocketbus.WebsocketBusServiceProvider;
import dev.webfx.stack.platform.websocketbus.WebSocketBusOptions;
...
public final class WebWebsocketBusServiceProvider extends WebsocketBusServiceProvider {
    ...
    public void setPlatformBusOptions(BusOptions options) {
        ...
        String json = ResourceService.getText("dev/webfx/stack/platform/core/services/bus/client/conf/BusOptions.json");
        if (json != null)
