...
public final class AuthorizationFactory {
    ...
    public static <Rq, Rs> AuthorizationRequest<Rq, Rs> newAuthorizationRequest() {
        return new AuthorizationRequest<Rq, Rs>().setUserPrincipal(FXUserPrincipal.getUserPrincipal());
    }

    public static <Rq, Rs> AuthorizationRequest<Rq, Rs> newAuthorizationRequest(Rq operationRequest) {
