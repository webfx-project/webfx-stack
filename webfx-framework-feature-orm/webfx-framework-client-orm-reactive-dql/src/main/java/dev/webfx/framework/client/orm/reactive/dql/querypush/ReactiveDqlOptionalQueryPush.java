package dev.webfx.framework.client.orm.reactive.dql.querypush;

import dev.webfx.framework.client.orm.reactive.dql.statement.ReactiveDqlStatement;
import dev.webfx.framework.client.orm.reactive.call.query.ReactiveQueryCall;
import dev.webfx.framework.client.orm.reactive.call.query.push.ReactiveQueryOptionalPush;
import dev.webfx.framework.client.orm.reactive.call.query.push.ReactiveQueryPushCall;
